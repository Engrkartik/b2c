...
<div class="page-content-wrapper">
    <div class="container">
                    ...
                    <div class="card weekly-product-card" id="cart-card">
                        ...
                        <div class="card-body d-flex align-items-center">
                            <div class="product-thumbnail-side" id="image-side">
                                ...
                                <a class="product-thumbnail d-block" href="category/shop-product/single-product/1"
                                    id="summary-img">
                                    <img src="http://34.72.9.224/quickWebsite/b2c_admin/public/images/item/levi.jpeg.webp"
                                        alt=""></a>

                            </div>
                            <div class="product-description">
                                <a class="product-title d-block" href="category/shop-product/single-product/1">Levi's
                                    Jeans</a>
                                ...
                                <p class="sale-price" id="1100_data" data-price="1100">₹1100<span
                                        style="color: #777474;">₹1500</span></p>
        ...
        <div class="card cart-amount-area">
            ...
            <div class="card-body d-flex align-items-center justify-content-between">
                <p class="total-price mb-0"><span>Total MRP</span></p>
                <p class="total-price mb-0">₹<span>1100</span></p>
            </div>
            <div class="card-body d-flex align-items-center justify-content-between">
                <p class="total-price mb-0"><span>Discount on MRP</span></p>
                <p class="total-price mb-0" style="color:#00a79d;">-₹<span>300</span></p>
            </div>
            <div class="card-body d-flex align-items-center justify-content-between">
                <p class="total-price mb-0"><span>Shipping Charges</span></p>
                <p class="total-price mb-0" style="color:#00a79d;"><span>Free</span></p>
            </div>
            <hr>
            <div class="card-body d-flex align-items-center justify-content-between">
                <h6 class="total-price mb-0"><span>Total Amount</span></h6>
                <h6 class="total-price mb-0">₹<span>900</span></h6>
            </div>
        </div>
