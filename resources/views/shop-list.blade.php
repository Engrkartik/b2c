                    ...
                    <div class="card top-product-card">
                        <div class="card-body">
                            ...
                            <div class="product-description"><a class="product-title d-block"
                                    href="single-product/{{$value->id}}">{{$value->title}}
                                    <p class="sale-price">
                                        ₹{{$value->sale_price}}&nbsp;&nbsp;<span>₹{{$value->mrp}}</span></p></a>
                                <input type="text" value="{{$value->id}}" id="product{{$value->id}}" name="product-id"
                                    hidden="">
            ...
            success: function (data) {
                ...
                if (data == "login") {
                   ...
                   location.reload();
                    ...
                    console.log(data);
                    // alert("#wish" + ht);
                    // $("#wish" + ht).find('i').removeClass().addClass("lni lni-heart");
                    if ($("#wish"+ht+" i").hasClass("lni lni-heart-filled")){
                      $("#wish"+ht+" i").removeClass("lni lni-heart-filled");
                      $("#wish"+ht+" i").addClass("lni lni-heart");
                  }
                  location.reload();


                    // // $("#wish"+ht).html('');
                    // $('#wish' + ht).append('<i class="lni lni-heart">');
