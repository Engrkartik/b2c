                ...
                <div class="row mb-4">
                 ...
                 <div class="row mb-4">
                  ...
                  <div class="col-sm" id="rightreg" style="margin-top: 13px;padding-left: 17px;">
                    @if($value->gender=='M')
                      <input class="form-check-input" id="male" type="radio" name="gender" value="M" checked>
                    @else
                    ...
                    @if($value->gender=='F')
                      <input class="form-check-input" id="female" type="radio" name="gender" value="F" checked>
                    @else
                    ...
                    @if($value->gender=='O')
                      <input class="form-check-input" id="other" type="radio" name="gender" value="O" checked>
                    @else
