                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card top-product-card">
                        <div class="card-body">
                            ...
                            <span class="badge badge-yellow"> Hot
                                <!-- -{{$value->discount}}% --></span>
                            <a class="wishlist-btn" onclick="removeWishlist('{{$value->id}}')"><i
                                    class="lni lni-heart-filled"></i></a>
                            <a class="product-thumbnail d-block"
                                href="category/shop-product/single-product/{{$value->id}}">
                                <img class="mb-2" src="{{ $value->img_url ? config('global.base_url').$value->img_url : url('/img/no-image-icon.png')  }}"
                                    alt=""></a>
                            <a class="product-title d-block"
                                href="category/shop-product/single-product/{{$value->id}}">{{$value->item_name}}</a>

                            <p class="sale-price"><i class="lni lni-rupee"></i>{{$value->sale_price}} <span
                                    style="color: #777474;">₹180</span></p>
                                ...
                                <div class="product-description">
                                    <div class="product-rating">
                                        <i class="lni lni-star-filled"></i><i class="lni lni-star-filled"></i><i
                                            class="lni lni-star-filled"></i><i class="lni lni-star-filled"
                                            id="emptyStar"></i><i class="lni lni-star-filled" id="emptyStar"></i>
                                    </div>
                                </div>
                            </div>
                            <a class="btn btn-success" href="" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                onclick="showModal('{{$value->id}}')" name="">ADD TO BAG</a>
            ...
            <div class="modal-footer">
                <form class="cart-form" action="#" method="">
                    <div class="order-plus-minus d-flex align-items-center">
                        ...
                        <input class="form-control cart-quantity-input" id="qty" type="text" step="1" name="quantity"
                            value="1">
                        <div class="quantity-button-handler">+</div>
                    </div>
                </form>
    ...
    function addCart() {
        ...
        if ($("input:radio[name='sizeRadio']").is(":checked")) {
            ...
            swal({
                icon: 'warning',
                title: 'Oops...',
                text: 'Sorry!! First select Colour and Size ',
            })
